...
CINEMA_VENUES = {
    "Краснодар": [
        "Киномакс-Краснодар, ул. Головатого, 313",
        "Монитор СБС, ул. Уральская, 79/1",
        "Монитор Красная Площадь, ул. Дзержинского, 100",
        "Формула Кино OZ, ул. Крылатая, 2",
        "КАРО 8, ул. В. Головатого, 313"
    ],
    "Сочи": [
        "Киноград, ул. Кирова, 58",
        "Сити Старс, ул. Транспортная, 28",
        "Люксор IMAX, ул. Новая Заря, 7"
    ],
    "Ростов-на-Дону": [
        "Киномакс-Дон, пр. М. Нагибина, 32/2",
        "Горизонт Cinema&Emotion, пр. М. Нагибина, 32/2",
        "Синема Стар, пр. М. Нагибина, 17"
    ],
    "Москва": [
        "Октябрь (КАРО 11), ул. Новый Арбат, 24",
        "Формула Кино Европа, пл. Киевского Вокзала, 2",
        "Киномакс-Мозаика, ул. 7-я Кожуховская, 9",
        "Синема Парк Ривьера, ул. Автозаводская, 18",
        "Иллюзион, Котельническая наб., 1/15"
    ],
    "Санкт-Петербург": [
        "Аврора, Невский пр., 60",
        "Мираж Синема на Большом, Большой пр. П.С., 35",
        "Кинополис, ул. Васи Алексеева, 6",
        "Формула Кино Галерея, Лиговский пр., 30а"
    ]
}
