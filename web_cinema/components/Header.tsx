                                    ...
                                    <div className="bg-[#1A1A1A]/90 backdrop-blur-md border border-white/10 rounded-xl shadow-2xl overflow-hidden p-4 space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Link
                                                href="/coupons"
                                                onClick={() => setMenuOpen(false)}
                                                className="w-full bg-white/10 hover:bg-white/20 text-gray-300 hover:text-white text-sm font-medium py-2 rounded-lg transition-colors flex items-center justify-center gap-2"
                                            >
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
